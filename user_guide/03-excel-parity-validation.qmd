...
The current reference run is **FAIL**: **612 / 3,468**
cell-level comparisons passed at `atol = 1e-06`.

- Result: **FAIL**
- Generated: `2026-07-20T00:34:40+00:00`
- Passed: **612**
- Failed: **2,856**
- Pass rate: **17.65%**
- Acceptance bar: **100.00%**

The sweep covers **3,468** cell-level comparisons against Excel.

## What Was Tested

The validation checks the exported standalone library, not just the extraction
graph. It imports `qcraft.api`, creates a fresh context for each scenario,
